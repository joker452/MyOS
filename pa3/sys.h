...
void SaveContext(CONTEXT *c);		// save context of current process in c
void RestoreContext(CONTEXT *c);	// restore context from c
int RefSwitchContext(int p);		// reference version of switch context 
